...
#cgo windows  CPPFLAGS:   -IC:/opencv/newbuild/install/include
#cgo windows  LDFLAGS:    -LC:/opencv/newbuild/install/x64/mingw/lib -lopencv_world455 -lopencv_img_hash455
*/
import "C"
